...
def launch_setup(context, *args, **kwargs):
    ...
    realsense2_launch_path = os.path.join(get_package_share_directory('eureka_camera_2'), 'launch', 'eureka_navcam_launch.py')
    realsense2 = IncludeLaunchDescription(PythonLaunchDescriptionSource(realsense2_launch_path))

    localization_launch_path = os.path.join(get_package_share_directory('eureka_localization'), 'launch', 'localization.launch.py')
    ...
    inverse_cmd = Node(
        package="eureka_inverse",
        executable="eureka_inverse",
        output="log",
        parameters=[],
        remappings=[],
